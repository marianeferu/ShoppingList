...
import com.example.shoppinglist_v4.adapters.CategorySuggestionAdapter;
import com.example.shoppinglist_v4.models.CategorySuggestion;
...
public class GetCategorySuggestionsFragment extends Fragment implements CategorySuggestionAdapter.OnItemClickListener  {
    ...
    public void onStart() {
        super.onStart();
       // setContentView(R.layout.fragment_categorysuggestion);
